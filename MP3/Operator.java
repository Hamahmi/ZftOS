...
public class Operator {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		System.out.println("Please input the input file name without extension (input-1) NOT (input-1.txt) :");
	...
	public static class Wheel extends Thread {
		...
		public void end_ride() {
			...
			if (totalPlayers == 0) {
				...
				System.out.println("No more players are waiting, thus the wheel has stopped!");
